...
\begin{keypoints}
  ...
  \item We find that REP-induced dose rates are unlikely to account for the difference between GCR modeling and aircraft dosimetry data.
\end{keypoints}
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=\textwidth]{figures_rev0/stopping_power.pdf}
  \caption{
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=\textwidth]{figures_rev0/example_histograms.pdf}
  \caption{
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=\textwidth]{figures_rev0/gcr_spectrum.pdf}
  \caption{
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=\textwidth]{figures_rev0/armas_residuals.pdf}
  \caption{
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=0.6\textwidth]{figures_rev0/elfin_example_data.pdf}
  \caption{
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=\textwidth]{figures_rev0/electron_spectrum.pdf}
  \caption{
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=.85\textwidth]{figures_rev0/excess_dose_comparison.pdf}
  \caption{
