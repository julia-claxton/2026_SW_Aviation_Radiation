...
%DIF DEL claxton2026_aviation_revision_0.tex   Sun Apr 19 12:28:20 2026
%DIF ADD claxton2026_aviation_revision_1.tex   Tue Apr 21 14:05:15 2026
...
\begin{figure}[H]
  \centering
  \noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/rev0/stopping_power.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/rev1/stopping_power.pdf}
  \DIFaddendFL \caption{
...
\begin{figure}[H]
  \centering
  \noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/rev0/example_histograms.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.8\textwidth]{figures/rev1/example_histograms.pdf}
  \DIFaddendFL \caption{
...
\begin{figure}[H]
  \centering
  \noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/rev0/gcr_spectrum.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/rev1/gcr_spectrum.pdf}
  \DIFaddendFL \caption{
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=\textwidth]{figures/rev1/case_studies.pdf}
  \caption{
...
%DIFDELCMD <   \centering
%DIFDELCMD <   \noindent\includegraphics[width=\textwidth]{figures/rev0/case_studies.pdf}
%DIFDELCMD <   %%%
%DIFDELCMD < \caption{%
{%DIFAUXCMD
...
\begin{figure}[H]
  \centering
  \noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/rev0/armas_residuals.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/rev1/armas_residuals.pdf}
  \DIFaddendFL \caption{
...
\begin{figure}[H]
  \centering
  \noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.6\textwidth]{figures/rev0/elfin_example_data.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.6\textwidth]{figures/rev1/elfin_example_data.pdf}
  \DIFaddendFL \caption{
...
\begin{figure}[H]
  \centering
  \noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{figures/rev0/electron_spectrum.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\textwidth]{figures/rev1/electron_spectrum.pdf}
  \DIFaddendFL \caption{
...
\begin{figure}[H]
  \centering
  \noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=.85\textwidth]{figures/rev0/excess_dose_comparison.pdf}
%DIFDELCMD <   %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=.85\textwidth]{figures/rev1/excess_dose_comparison.pdf}
  \DIFaddendFL \caption{
...
\DIFaddbegin \DIFadd{It is also worth noting that there are other effects that may contribute to the discrepancy between ARMAS measurements and  predictions. Firstly, both NAIRAS and SEPIIDA predict GCR-induced dose rates with no shielding. In reality, the fuselage of an aircraft provides some shielding from incident particles and may also generate additional particle showers, potentially affecting the dose rates measured from inside an aircraft cabin. Furthermore, NAIRAS parameterizes altitude by barometric pressure, while the ARMAS dataset utilizes GPS data to calculate altitude. Altitudes computed with different methods may differ slightly, adding another potential source of discrepancy between the datasets. 
}
...
ELFIN data \cite{angelopoulos2020} is available for free at \url{https://data.elfin.ucla.edu/ela/}. Geant4 \cite{geant4} is available for free from \url{https://geant4.web.cern.ch/download/11.3.2.html}. The SEPIIDA code used to generate lookup tables is available for free at \DIFdelbegin %DIFDELCMD < \url{https://doi.org/10.5281/zenodo.18473010}%%%
\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeA{code-citation-aviationg4}}\hskip0pt%DIFAUXCMD
}\DIFaddend . The atmospheric response lookup tables generated by the Geant4 simulation are available for free at \DIFdelbegin %DIFDELCMD < \url{https://doi.org/10.5281/zenodo.18473107}%%%
\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeA{data-citation-tables}}\hskip0pt%DIFAUXCMD
}\DIFaddend . All code used to perform the analysis and generate figures for this paper is available for free at \DIFdelbegin %DIFDELCMD < \url{https://doi.org/10.5281/zenodo.18473200} %%%
\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citeA{code-citation-mainrepo}}\hskip0pt%DIFAUXCMD
}\DIFaddend . Analysis was performed using the Julia coding language \cite{julia-language}, NumPy \cite{numpy}, SpacePy \cite{spacepy1, spacepy2}, and Matplotlib \cite{matplotlib}.
\DIFdelbegin %DIFDELCMD < 

%DIFDELCMD < %%%
%DIF < \cite{code-citation-aviationg4}
%DIF < \cite{data-citation-tables}
%DIF < \cite{code-citation-mainrepo}
\DIFdelend 
