...
We begin by attempting to explain the ARMAS dose rate measurements using an estimate of GCR-induced dose rates. In addition to validating the SEPIIDA model, these simulations provide a picture of data-driven dose rates produced by GCRs and their day-to-day variability based on direct measurements from LEO.
...
\begin{figure}[H]
  \centering
  \noindent\includegraphics[width=\textwidth]{figures/stopping_power.pdf}
  \caption{
