...
It is worth noting that there are other effects that may contribute to the discrepancy between ARMAS measurements and NAIRAS. Firstly, both NAIRAS and SEPIIDA predict dose rates in air with no shielding. In reality, the fuselage of an aircraft provides some shielding from directly incident particles and may generate new particle showers via interaction with incident particles. 
